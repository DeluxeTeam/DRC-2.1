...
package com.deluxelabs.drc.app_fragments;
...
import com.deluxelabs.drc.adapters.AdapterBackups;

import java.io.File;
import java.io.FileFilter;

import static com.deluxelabs.drc.app_fragments.DlgFrRestore.RESTORE_STATE.ASK_BACKUP;
import static com.deluxelabs.drc.app_fragments.DlgFrRestore.RESTORE_STATE.CONFIRM_BACKUP_FILE;
...
public class DlgFrRestore extends DialogFragment {
    ...
    public interface OnDlgFrRestoreActionListener {
        void processDlgFrRestoreAction(RESTORE_STATE next_action, String info);
    }
    ...
    public void onDismiss(DialogInterface dialog){
        ...
        if(mCallBack!=null)
             mCallBack.processDlgFrRestoreAction(mRestoreState,mReturnedString);
    ...
    private void report_error(String error){
        if(mCallBack!=null) mCallBack.processDlgFrRestoreAction(RESTORE_STATE.ERROR,error);
    }
    ...
    private View getBackupsListView(){
        ...
        if(fa==null || fa.length==0) {
            ...
            AdapterBackups ab = new AdapterBackups(getActivity(), fa);
