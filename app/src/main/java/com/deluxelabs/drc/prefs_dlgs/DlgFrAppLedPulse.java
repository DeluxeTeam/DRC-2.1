...
public class DlgFrAppLedPulse extends DialogFragment implements  DlgGrxAppSelection.OnGrxAppListener {
    ...
    public View getDialogView() {
        ...
        mSMColorPicker.setOnColorChangedListener(color -> setSMColor(color,true));
        ...
        if(mShowPulse){
            ...
            mSpinnerOn.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                    ...
                    mLedOnTime=Integer.parseInt(getActivity().getResources().getStringArray(R.array.grxa_ledpulse_ton_values)[i]);
                    updateLedNotification();
                    mNotificationManager.notify(1,mNotification); //*****
                }
            ...
            mSpinnerOff.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                @Override
                public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                    mLedoffTime=Integer.parseInt(getActivity().getResources().getStringArray(R.array.grxa_ledpulse_toff_values)[i]);
                    updateLedNotification();
                    mNotificationManager.notify(1,mNotification); //*****
                }
    ...
    private void setSMColor(int color, boolean updatetext){
    ...
    private void turnScreenOff(){
        try{
            ...
            if(RootUtils.runCommand("input keyevent 26")==null) Toast.makeText(this.getActivity(),getString(R.string.grxs_pulse_no_screenoff),Toast.LENGTH_SHORT).show();
    ...
    private void initSpinnersFromValue(String value){
        ...
        mLedOnTime=Integer.parseInt(getActivity().getResources().getStringArray(R.array.grxa_ledpulse_ton_values)[poson]);
        ...
        mLedoffTime=Integer.parseInt(getActivity().getResources().getStringArray(R.array.grxa_ledpulse_toff_values)[posoff]);
    }
    ...
    @Override
    public void onGrxAppSel(String packagename){
