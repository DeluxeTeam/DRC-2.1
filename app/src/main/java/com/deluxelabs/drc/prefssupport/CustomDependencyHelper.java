...
public class CustomDependencyHelper {
    ...
    final GrxPreferenceScreen.CustomDependencyListener mListener;
    ...
    public CustomDependencyHelper(GrxPreferenceScreen.CustomDependencyListener listener, String rule){
   ...
   public boolean listener_should_be_enabled(String value){
       ...
       switch (mDependencyType){
           ...
           case 2:
               ...
               if(matched) return mEnableDependent;
